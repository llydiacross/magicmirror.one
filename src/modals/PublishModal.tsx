              ...
              <div className="bg-white rounded-md w-full overflow-y-auto max-h-screen shadow shadow-lg border-2">
                <div className="flex flex-col w-full">
                  ...
                  <p className="text-black text-center p-2">
                    You are nearly done! Simply press the button below to update
                    your ens content hash!
                  </p>

                  <div className="btn-group w-full mt-2 mb-2 p-2">
                    <button
                      className="btn btn-primary"
                      disabled={ensContext.owner !== context.walletAddress}
                      onClick={() => {
                        setError(null);
                        setContentHash(savedCid).catch((error) => {
                          console.log(error);
                          setError(error);
                          setLoading(false);
                        });
                ...
                <div className="flex flex-col p-2 w-full mt-2">
                  ...
                  {totalPercent > 100 ? (
                    <>
                      <div className="text-red-500 text-center mt-3">
                        <b>⚠️</b> Your total payload size is over the limit of
                        12mb
                      </div>
                    </>
                  ) : (
                  ...
                  <div className="btn-group w-full mt-2">
                    <button
                      className="btn"
                      disabled={
                        totalPercent > 100 || size === 0 || tabSize === 0
                      }
                      onClick={() => {
                        setError(null);
                        publish().catch((error) => {
